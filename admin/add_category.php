...
$book_author=$_POST["book_category"];

$existsql="INSERT INTO `category` (`cat_name`) VALUES ('$book_author');"; 
...
<section class="background-radial-gradient overflow-hidden">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="book_category" class="form-control" id="name"  required>
  </div>
  ...
  <button type="submit" class="btn btn-primary container my-3">ADD</button>
</form>
          </div>
        </div>
      </div>
