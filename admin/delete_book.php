...
<?php
require "../connect.php";
$sql="delete from book where book_no=$_GET[bn]"; 
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <?php
                      require "../connect.php";
                      $sql= "select book.book_name,book.book_no,book.book_price,authors.author_name from book left join authors on book.author_id=authors.author_id";
                      $result=mysqli_query($connect,$sql);
