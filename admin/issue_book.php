...
$existsql="INSERT INTO `issued_books` (`book_no`, `book_name`, `book_author`, `student_id`, `Status`, `issued_date`) VALUES ('$book_number', '$book_name', '$book_author', '$student_id', '1', current_timestamp());"; 
...
if($result ){
  ...
  alert("Book Issued Successfully"); 
    ...
    echo '<script>
  alert("sorry NOt issued try after some time"); 
...
<section class="background-radial-gradient overflow-hidden">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="book_number" class="form-control" id="book_name"  required>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="book_author" class="form-control" id="author" required>
  </div>
  
  <div class="mb-3">
    <label for="student_id" class="form-label">Student id</label>
    <input type="text" name="student_id" class="form-control" id="student_id" maxlength="10" length="10" required>
  </div>
