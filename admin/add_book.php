...
$existsql="INSERT INTO `book` (`book_name`, `author_id`, `cat_id`, `book_no`, `book_price`) VALUES ('$book_name', '$book_author', '$book_category', '$book_number', '$book_price');"; 
...
if($result ){
  ...
  alert("Book Added Successfully"); 
    ...
    echo '<script>
  alert("sorry NOt added to the datbase try after some time"); 
...
<section class="background-radial-gradient overflow-hidden">
  ...
  <div class="mb-3">
    ...
    <input type="number" name="book_number" class="form-control" id="name"  required>
  </div>
  <div class="mb-3">
    <label for="book_name" class="form-label">Book Name</label>
    <input type="text" name="book_name" class="form-control" id="book_name" aria-describedby="emailHelp" required>
    
  </div>
  <div class="mb-3">
    <label for="category" class="form-label">Category id</label>
    <input type="number" name="book_category" class="form-control" id="category" required>
  </div>
  <div class="mb-3">
    <label for="author" class="form-label">Author id</label>
    <input type="number" name="book_author" class="form-control" id="author" >
    
  </div>
  <div class="mb-3">
    <label for="price" class="form-label">Book Price</label>
    <input type="number" name="book_price" class="form-control" id="price" maxlength="10" length="10" required>
  </div>
  ...
  <button type="submit" class="btn btn-primary container my-3">Add Book</button>
</form>
          </div>
        </div>
      </div>
